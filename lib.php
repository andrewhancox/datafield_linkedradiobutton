...
/**
 * @package datafield_linkedradiobutton
...
function datafield_linkedradiobutton_override_webservice_execution($externalfunctioninfo, $params) {
...
function datafield_linkedradiobutton_recursivestrreplace(&$obj) {
    foreach ($obj as $key => $value) {
        if (is_string($value)) {
            $obj->$key = str_replace('linkedradiobutton', 'radiobutton', $value);
        } else if (is_iterable($value)) {
            datafield_linkedradiobutton_recursivestrreplace($value);
        }
    }
}
