...
class data_field_linkedradiobutton extends data_field_radiobutton {

    public $type = 'linkedradiobutton';
    ...
    function image() {
        ...
        $str = '<a href="' . $link->out() . '">';
        $str .= $OUTPUT->pix_icon('linkedradiobutton', 'linkedradiobutton', 'datafield_linkedradiobutton');
        $str .= '</a>';
        return $str;
    }
}
